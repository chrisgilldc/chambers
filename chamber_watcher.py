...
class ChamberWatcher:
    ...
    def __init__(self, mqtt_host, mqtt_username, mqtt_password, ha_prefix='homeassistant', mqtt_port=1883, mqtt_qos=0,
                 mqtt_client_id = 'chambers', mqtt_base = 'chambers', ha_base = 'homeassistant', log_level=logging.DEBUG):
        """
        ...
        :param ha_prefix: Home assistant topic prefix. Defaults to 'homeassistant'.
        ...
        self._house = chambers.House()
        self._senate = chambers.Senate()
    ...
    def _create_mqtt_client(self):
        ...
        # Set last will
        self._mqtt_client.will_set(self._topics["running"], payload="true", qos=self._mqtt_qos, retain=True)
        # Connect callbacks.
    ...
    def _on_disconnect(self, client, userdata, flags, rc, properties=None):
        ...
        if rc != 0:
            ...
            self._mqtt_connected = "Disconnected"
        else:
            self._mqtt_connected = "Disconnected-Planned"
    ...
    def run(self):
        ...
        while True:
            ...
            if self._house.update():
                ...
                self._pub_message(self._topics['house_adjourned_at'], self._house.convened_at)
            ...
            if self._senate.update():
                ...
                self._pub_message(self._topics['senate_adjourned_at'], self._senate.convened_at)
...
if __name__ == "__main__":
    ...
    #TODO: Add environment getting here.
    cw = ChamberWatcher(
        mqtt_host="172.18.47.10",
        mqtt_username="chambers",
        mqtt_password="qQa#2XJmDOZoq#wy"
    )
    cw.run()